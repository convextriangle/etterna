...
class Display : public RageDisplay
{
  public:
    ...
    [[nodiscard]] const RagePixelFormatDesc *GetPixelFormatDesc(RagePixelFormat pf) const override;

    bool BeginFrame() override;
    void EndFrame() override;
    [[nodiscard]] const ActualVideoModeParams *GetActualVideoModeParams() const override;
    ...
    {
        return m_Renderer->IsD3DInternal();
    }
